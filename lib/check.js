(function(global) {
  ...
  function _isType(type) {
    ...
    /**
     * Closure, checks every element of the class for the given type.
     * Returns true if every element pass the test, false otherwise.
     * Also negation can change the result.
     * @return {Boolean}
     */
    return function() {
